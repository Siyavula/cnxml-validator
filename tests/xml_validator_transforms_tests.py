...
class FormatNumberTest(unittest.TestCase):
    ...
    def test_scientific_notation_with_parameter(self):
        ...
        self.assertEqual(format_number('1e10', iScientificNotation=u'%se%s'), u'1e10')
        self.assertEqual(format_number(
...
class NumberTextTest(unittest.TestCase):
    ...
    def test_integer_input(self):
        ...
        element.text = '5'
        self.assertTrue(is_number(element))
        element1 = etree.Element('number')
        element1.text = '-3'
        self.assertTrue(is_number(element1))
