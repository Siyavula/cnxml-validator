...
class XmlValidatorChildrenUncombinedTests(TestCase):
    ...
    def test_validate_with_valid_xml_reference_children(self):
        """This tests a tag that references another entry for the child tag"""
        good_template_dom = etree.fromstring('<test-element-reference-child><reference-child></reference-child></test-element-reference-child>')
...
class XmlValidatorChildrenCombinedTests(TestCase):
    ...
    def test_validate_with_invalid_xml_oneof_anynumber_children_raises_error(self):
        ...
        Either of the required children can be present 
        but not both and any number of the present child can be used.
        This test should not raise a validation error but it does.
        This is due to the fact that validator itself uses dodgy regex to check
        the children tags and in the future we must fix this.
        """
    ...
    def test_validate_with_valid_xml_anynumber_from_children(self):
        """This tests a tag that contains any-number from 1 of the children."""
        good_template_dom = etree.fromstring('<test-element-anynumber-from-children><test-child-required></test-child-required><test-child-required></test-child-required></test-element-anynumber-from-children>')
    ...
    def test_validate_with_invalid_xml_anynumber_from_children_raises_error(self):
        """This tests a tag that contains any-number from 1 of the children."""
        bad_template_dom = etree.fromstring('<test-element-anynumber-from-children></test-element-anynumber-from-children>')
...
class XmlValidatorTagAttributes(TestCase):
    ...
    def test_validate_with_valid_xml(self):
        """This tests the basic pattern of a tag with no attributes."""
        good_template_dom = etree.fromstring('<test-element-no-attributes></test-element-no-attributes>')
    ...
    def test_validate_with_valid_xml_string_attribute_no_default(self):
        ...
        good_template_dom = etree.fromstring('<test-element-string-attribute-no-default id="my id"></test-element-string-attribute-no-default>')

        assert self.xml_validator.validate(good_template_dom) is None

    def test_validate_with_valid_xml_integer_attribute_no_default(self):
        """This tests the basic pattern of a tag with an attribute of type integer."""
        good_template_dom = etree.fromstring('<test-element-integer-attribute-no-default precision="5"></test-element-integer-attribute-no-default>')
    ...
    def test_validate_with_valid_xml_integer_attribute_with_default(self):
        """This tests the basic pattern of a tag with an attribute of type integer. There is a default set and so we are testing leaving out the attribute here."""
        good_template_dom = etree.fromstring('<test-element-integer-attribute-with-default></test-element-integer-attribute-with-default>')
    ...
    def test_validate_with_invalid_xml_integer_attribute_no_default(self):
        """This tests the basic pattern of a tag with an attribute of type integer."""
        bad_template_dom = etree.fromstring('<test-element-integer-attribute-no-default precision="ten"></test-element-integer-attribute-no-default>')
    ...
    def test_validate_with_invalid_xml_enum_attribute_no_default(self):
        """This tests the basic pattern of a tag with an attribute of type enum."""
        bad_template_dom = etree.fromstring('<test-element-enum-attribute-no-default type="ten"></test-element-enum-attribute-no-default>')
