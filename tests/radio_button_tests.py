...
class RadioButtonValidatorTests(TestCase):
    ...
    def test_validate_with_radio_buttons_without_text_second_variant(self):
        """validate: None when radio buttons do not have text, i.e. <button/> """
        good_template_dom = etree.fromstring('''
        <exercise-container>
            <meta>
            </meta>
            ...
            <query>
                <radio>
                    <button>
                        ...
                        tempor incididunt ut labore et dolore magna aliqua. Number
                        <number>3.14</number> Nth e.g. <nth>1</nth> Percentages e.g.
                        <percentage>34</percentage> Super- and subscripts e.g. <sup>up</sup>
                        <sub>down</sub> Units e.g. <unit>m&#183;s<sup>-1</sup></unit>
                        Numbers with units e.g.
                        <unit_number><number>3.14</number><unit>m&#183;s<sup>-1</sup></unit>
                        </unit_number> Currency e.g. <currency><number>3.14</number></currency>
                        Chemical compound e.g. <chem_compound>H_2O</chem_compound> Spectroscopic
                        notation e.g. <spec_note>3s^{2}3p^{5}</spec_note> Nuclear notation e.g.
                        <nuclear_notation><symbol>Z</symbol><mass_number>x</mass_number>
                        <atomic_number>y</atomic_number></nuclear_notation> Emphasis e.g.
                        <emphasis>boom!</emphasis> Style (font colour) e.g.
                        <style font-color="red">hypotenuse</style> In-line latex e.g.
                        <latex>e^{i\pi} + 1 = 0</latex> In-line tip e.g.
                ...
                <response>
                    <query>
                        <radio>
                            <button>
                                <quote>
                                    <emphasis>Something</emphasis> is the thing that defines the law
                                </quote>
                            </button>
                            <button>
                                <quote>
