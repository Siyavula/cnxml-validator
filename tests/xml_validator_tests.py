...
class ExerciseValidatorTests(TestCase):
    ...
    def test_validate_with_currency_tag_no_children(self):
        """
        Raise an error since currency is required to contain at least the number tag.
    ...
    def test_validate_with_pspicture_tag_no_children(self):
        """
        Raise an error since currency is required to contain at least either src or code child.
